...
var jstpl_cardtool1='<div class="cardtoolset1" style="background-position-x: ${x}%; background-position-y: ${y}%;"></div><div style="text-align: center; font-weight: bold;">${name}</div><div style="text-align: left;">${description5}</div><div style="text-align: left;">${description4}</div><div style="text-align: left;">${description3}</div>';
var jstpl_cardtool2='<div class="cardtoolset2" style="background-position-x: ${x}%; background-position-y: ${y}%;"></div><div style="text-align: center; font-weight: bold;">${name}</div><div style="text-align: left;">${description5}</div><div style="text-align: left;">${description4}</div><div style="text-align: left;">${description3}</div>';
var jstpl_cardtool3='<div class="cardtoolset3" style="background-position-x: ${x}%; background-position-y: ${y}%;"></div><div style="text-align: center; font-weight: bold;">${name}</div><div style="text-align: left;">${description5}</div><div style="text-align: left;">${description4}</div><div style="text-align: left;">${description3}</div>';
var jstpl_aidetool='<div class="aidetool"></div><div style="text-align: center; font-weight: bold;">${name1}</div><div style="text-align: justify;">${texte1}</div><br><div style="text-align: justify;">${texte2}</div><div style="text-align: justify;">${texte3}</div><div style="text-align: justify;">${texte4}</div><br><div style="text-align: justify;">${texte5}</div><br><div style="text-align: center; font-weight: bold;">${name2}</div><div style="text-align: justify;">${texte6}</div>';
