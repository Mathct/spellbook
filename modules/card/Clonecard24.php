...
class Clonecard24 extends Card
{
    public function arginit($parg1, $parg2)
    {
        ...
        if (spellbook::$instance->getGameStateValue('solo')==1)
        {
            if ((($nombrerunereserve<2)||($nombrefamilier>12))&&(($nombrereserve>8)&&($nombreruneautel<1)))
            {
                $ret['titleyou'] = clienttranslate('${you} cannot trigger this spell');
                $ret['buttons'][]='cancel';
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            if($varg1 == NULL)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power4");
            }
            else
            {
        ...
        if ($level == 1)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power3");
        }
        ...
        if ($level == 3)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power5");
        }
            }
        }
    ...
    public function Power3($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power3Confirm", $varg1);
        }
    ...
    public function Power4($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power4Store2");
        }

        if($varg1 == "card24take1")
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power4Take1");
        }
    ...
    public function Power4Take1($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power4Take1Confirm", $varg1);
        }
    ...
    public function Power4Store2Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "FOCUS" (Clone) and stores ${log1} ${log2}'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($log[0]),
    ...
    public function argPower5($parg1, $parg2)
    {
        ...
        $ret["selected"][] = 'materiacard_4_'.spellbook::$instance->getGameStateValue('idclone').'_3';
    ...
    public function Power5($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power5Store3");
        }

        if($varg1 == "card24take2")
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard24", "Power5Take2");
        }
    ...
    public function Power5Take2Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {  */
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "FOCUS" (Clone) and takes ${log1} ${log2}'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($log[0]),
                'log2' => spellbook::$instance->getLogsType($log[1]),
    ...
    public function Power5Store3Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/  
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "FOCUS" (Clone) and stores ${log1} ${log2} ${log3}'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($log[0]),
                'log2' => spellbook::$instance->getLogsType($log[1]),
