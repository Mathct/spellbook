...
class Card23 extends Card
{
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            ...
            if($varg1 == NULL)
            {
                ...
                if ($level == 1)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Card23", "Step2", 3);
        }

        if ($level == 2)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Card23", "Step2", 4);
        }

        if ($level == 3)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Card23", "Step2", 5);
        }
            }
    ...
    public function Step2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($parg1 == "3")
        {
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "CURE" and draws ${log1}'), array(
                'player_name' => $this->player_name,
                ...
                spellbook::$instance->addPendingTarget($this->player_id, "Card23", "Step3", 3);
        ...
        if ($parg1 == "4")
        {
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "CURE" and draws ${log1} ${log2}'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($log1),
            ...
            spellbook::$instance->addPendingTarget($this->player_id, "Card23", "Step3", 4);
        }
        ...
        if ($parg1 == "5")
        {
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "CURE" and draws ${log1} ${log2} ${log3}'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($log1),
                'log2' => spellbook::$instance->getLogsType($log2),
            ...
            spellbook::$instance->addPendingTarget($this->player_id, "Card23", "Step3", 5);
        }
    //}
    ...
    {
        spellbook::$instance->addPendingTarget($this->player_id, "Card23", "Confirm1", $varg1);
