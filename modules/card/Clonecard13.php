...
class Clonecard13 extends Card
{
    public function arginit($parg1, $parg2)
    {
        ...
        $level = intval(self::getUniqueValueFromDB("SELECT `power` FROM `cards` WHERE `player_id`={$player} AND `set_color` = 3 AND `typerune` !=0")); //////ATTENTION set_color = coleur de la carte
        ...
        {
            if (($countreserve<2)||($countautel<2))
            {
                $ret['titleyou'] = clienttranslate('${you} cannot trigger this spell');
                $ret['buttons'][]='cancel';
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            if($varg1 == NULL)
            {
                ...
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard13", "Swap2");
            }
            else
            {
        ...
        if ($level == 1)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard13", "Swap1");
        }
        ...
        {
            spellbook::$instance->setGameStateValue('selectautel', 0);
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard13", "Swap3");
        }
            }
        }
    ...
    public function Swap1($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard13", "Swap12", $varg1);
        }
    ...
    public function Swap12($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard13", "Swap1Confirm", $parg1, $varg1);
        }
    ...
    public function Swap1Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            spellbook::$instance->notifyAllPlayers('move','', array(
                ...
                spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "PURIFICATION" (Clone) and swaps ${log1} from the reserve with ${log2} from the altar'), array(
    ...
    public function Swap2Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "PURIFICATION" (Clone) and swaps ${log1} ${log2} from the reserve with ${log3} ${log4} from the altar'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($logreserve1),
    ...
    public function Swap3Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "PURIFICATION" (Clone) and swaps ${log1} ${log2} ${log3} from the reserve with ${log4} ${log5} ${log6} from the altar'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($logreserve1),
                'log2' => spellbook::$instance->getLogsType($logreserve2),
