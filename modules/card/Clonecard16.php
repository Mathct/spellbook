...
class Clonecard16 extends Card
{
    public function arginit($parg1, $parg2)
    {
        ...
        if($testpouvoirbleu == 0)
        {
            ...
            if (($maxrune == 2)&&($nombrerunenonbleu == 1))
            {
                $nbremaxrune = 1;
            }
            if (($maxrune == 2)&&($nombrerunenonbleu >=2))
            {
                $nbremaxrune = 2;
            }
            $calcul = $nombrebleu + $nbremaxrune; 
            if ($calcul >= 3)
            {
                $test = 1;
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard16", "Step2", $varg1);
        }
    ...
    public function Step2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            ...
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard16", "Step3", $varg1);
        }
    ...
    function Controle ($parg1, $parg2, $varg1, $varg2)     /// controle de la selection
    {
        ...
        {
            $test =1;
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard16", "Step3", $selected, 'error');
        }
    ...
    function Step4($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            $selected = 'materiacard_'.spellbook::$instance->getGameStateValue('color').'_'.$this->player_id.'_'.spellbook::$instance->getGameStateValue('position');
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard16", "Step3", $selected);
        }

        else
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard16", "Confirm", $parg1, $varg1);
