...
class Clonecard32 extends Card
{
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            ...
            if($varg1 == NULL)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "Confirm", 4);
            }
            else
            {
            ...
            if ($level == 1)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "Confirm", 3);
            }
            ...
            if ($level == 3)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "Confirm", 5);
            }
            }
        }
    ...
    public function Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            if($parg1 =="3")
            {
                ...
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "Take2");

            }

            if($parg1 =="4")
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "Color");
            }
    ...
    public function Color($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "ColorStep2", $varg1);
        }
    ...
    public function ColorStep2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "ColorStep3", $parg1);
        }
        
        if(($varg1 != "cancel")&&($varg1 != "takeonlyone"))
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "ColorStep3", $parg1, $varg1);
        }
    ...
    public function ColorStep3($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            if ($parg2 ==NULL)
            {
                ...
                spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "DIVINATION" (Clone) and takes ${log1}"'), array(
                    'player_name' => $this->player_name,
                    'log1' => spellbook::$instance->getLogsType($log[0]),
            ...
            if($parg2 !=NULL)
            {
                ...
                spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "DIVINATION" (Clone) and takes ${log1} ${log2}"'), array(
                    'player_name' => $this->player_name,
                    'log1' => spellbook::$instance->getLogsType($log[0]),
    ...
    public function Take2Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/ 
            ...
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "Discard");
            }

            else
            {
                spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "DIVINATION" (Clone)'), array(
                    'player_name' => $this->player_name,
    ...
    public function Discard($parg1, $parg2, $varg1, $varg2)
    {
        ...
        spellbook::$instance->addPendingTarget($this->player_id, "Clonecard32", "DiscardConfirm", $varg1);
