...
class Clonecard21 extends Card
{
    public function arginit($parg1, $parg2)
    {
        ...
        $level = intval(self::getUniqueValueFromDB("SELECT `power` FROM `cards` WHERE `player_id`={$player} AND `set_color` = 1 AND `typerune` !=0")); //////ATTENTION set_color
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            ...
            if($varg1 == NULL)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard21", "Confirm", 4);
            }
            else
            {
            ...
            if ($level == 1)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard21", "Confirm", 3);
            }
            ...
            if ($level == 3)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard21", "Confirm", 5);
            }
            }
        }
