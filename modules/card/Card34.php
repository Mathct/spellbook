...
class Card34 extends Card
{
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            if($varg1 == NULL)
            {
                ...
                if ($level == 1)
                {
                    spellbook::$instance->addPendingTarget($this->player_id, "Card34", "Power3");
                }
        
                if ($level == 2)
                {
                    spellbook::$instance->addPendingTarget($this->player_id, "Card34", "Power4");
                }
            }
            else
            {
    ...
    public function Power3($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Card34", "Power3Confirm", $varg1);
        }
    ...
    public function Power3Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "FEAST" and takes ${log1}'), array(
                'player_name' => $this->player_name,
    ...
    public function Power4($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Card34", "Power4Confirm", $varg1);
        }
    ...
    public function Power4Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "FEAST" and stores ${log1} from the Altar'), array(
                'player_name' => $this->player_name,
                'log1' => spellbook::$instance->getLogsType($log[0]),
