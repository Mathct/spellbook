...
class Clonecard14 extends Card
{
    public function arginit($parg1, $parg2)
    {
        ...
        {
            if (($countreserve<3)||($countfamilier>11)||(($nombrerouge <3)&&($nombreviolet <3)&&($nombrevert <3)&&($nombrenoir <3)&&($nombreblanc <3)&&($nombrebleu <3)&&($nombrejaune <3)))
            {
                $ret['titleyou'] = clienttranslate('${you} cannot trigger this spell');
                $ret['buttons'][]='cancel';
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            if($varg1 == NULL)
            {
                spellbook::$instance->addPendingTarget($this->player_id, "Clonecard14", "Step2", 4);
            }
            else
            {
        ...
        if ($level == 1)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard14", "Step2", 3);
        }
        ...
        if ($level == 3)
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard14", "Step2", 5);
        }
            }
        }
    ...
    public function Step2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {
            spellbook::$instance->addPendingTarget($this->player_id, "Clonecard14", "Step3", $parg1, $varg1);
        }
    ...
    public function Confirm($parg1, $parg2, $varg1, $varg2)
    {
        ...
        {*/
            ...
            if ($nombremateria == 2)
            {
                ...
                spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "OFFERING" (Clone) and stores ${log1} ${log2}'), array(
            ...
            if ($nombremateria == 3)
            {
                ...
                spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "OFFERING" (Clone) and stores ${log1} ${log2} ${log3}'), array(
                    'player_name' => $this->player_name,
                    'log1' => spellbook::$instance->getLogsType($log1),
                    'log2' => spellbook::$instance->getLogsType($log2),
            ...
            if ($nombremateria == 4)
            {
                ...
                spellbook::$instance->notifyAllPlayers('message',clienttranslate( '${player_name} triggers "OFFERING" (Clone) and stores ${log1} ${log2} ${log3} ${log4}'), array(
                    'player_name' => $this->player_name,
                    'log1' => spellbook::$instance->getLogsType($log1),
                    'log2' => spellbook::$instance->getLogsType($log2),
                    'log3' => spellbook::$instance->getLogsType($log3),
